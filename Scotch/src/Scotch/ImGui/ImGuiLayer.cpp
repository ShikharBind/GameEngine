...
namespace Scotch {
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// Temporary : should eventually use Scotch Key codes
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<WindowResizeEvent>(SH_BIND_EVENT_FN(ImGuiLayer::OnWindowResizedEvent));
	}
	...
	{
		ImGuiIO& io = ImGui::GetIO();
		SH_TRACE("{0} {1}", e.GetMouseButton(), io.MouseDown[e.GetMouseButton()]);
